	...
	public class PropertyGrid : SingleItemContainer<Grid>
	{
		...
		private class SubGrid : SingleItemContainer<Grid>
		{
			...
			public Rectangle HeaderBounds
			{
				get
				{
					var headerBounds = new Rectangle(ActualBounds.X, ActualBounds.Y, ActualBounds.Width,
						InternalChild.GetRowHeight(0));
			...
			public SubGrid(PropertyGrid parent, object value, string header, string category, string filter,
		...
		[Browsable(false)] [XmlIgnore] public TreeStyle PropertyGridStyle { get; private set; }
		...
		[Browsable(false)] [XmlIgnore] public string Category { get; private set; }
		...
		public bool IsEmpty
		{
			get { return InternalChild.Widgets.Count == 0; }
		}
		...
		{
			get { return (int) InternalChild.ColumnsProportions[0].Value; }

			set { InternalChild.ColumnsProportions[0].Value = value; }
		}
		...
		[Browsable(false)] [XmlIgnore] public Func<Record, object[]> CustomValuesProvider;

		[Browsable(false)] [XmlIgnore] public Func<Record, object, object, bool> CustomSetter;
